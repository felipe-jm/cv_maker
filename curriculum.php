...
<body>
  ...
  <div class="container-fuid text-left mx-3 my-3">
    <img class="img-fluid img-thumbnail float-right" src="upload/cosmos.jpg">
    <h4><?php echo $_POST['primeiro-nome'] . ' ' . $_POST['sobrenome']; ?></h4>
